...
.btn::after{
  content:"";position:absolute;top:0;bottom:0;left:-55%;width:42%;pointer-events:none;
  background:linear-gradient(100deg,rgba(255,248,238,0) 0%,rgba(255,248,238,.12) 30%,rgba(255,248,238,.58) 50%,rgba(255,248,238,.12) 70%,rgba(255,248,238,0) 100%);
  transform:skewX(-18deg);
  animation:btn-shimmer 5s cubic-bezier(.4,0,.2,1) infinite;
}
@keyframes btn-shimmer{0%{left:-55%}42%{left:120%}100%{left:120%}}
