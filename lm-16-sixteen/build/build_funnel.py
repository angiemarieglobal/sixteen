...
:root{
  ...
  /* cool balance, the complementary tone. Patina Sage family, amg-brand-boards. */
  --sage-still:#7E8C7A; --sage-ink:#465240; --sage-edge:#B4C0AC; --sage-veil:#E8EDE3;
...
.btn{
  ...
  padding:24px 46px;border-radius:999px;
  font-family:'Montserrat',sans-serif;font-weight:600;
  text-transform:uppercase;letter-spacing:.2em;font-size:13px;
  box-shadow:0 2px 14px rgba(42,23,17,.12);
  transition:background .32s ease,color .25s ease,border-color .25s ease,transform .25s ease,box-shadow .32s ease;
}
.btn:hover{transform:translateY(-2px);box-shadow:0 12px 28px rgba(42,23,17,.20)}
.btn:active{transform:translateY(0);box-shadow:0 2px 10px rgba(42,23,17,.16)}
.btn::before,.btn::after{
  content:"";position:absolute;top:0;bottom:0;left:-52%;width:40%;pointer-events:none;
  background:linear-gradient(100deg,rgba(255,248,238,0) 0%,rgba(255,248,238,.10) 30%,rgba(255,248,238,.50) 50%,rgba(255,248,238,.10) 70%,rgba(255,248,238,0) 100%);
  transform:skewX(-18deg);
  animation:btn-shimmer 3.2s linear infinite;
}
.btn::before{animation-delay:-1.6s}
@keyframes btn-shimmer{from{left:-52%}to{left:118%}}
@media (prefers-reduced-motion:reduce){.btn::before,.btn::after{animation:none;opacity:0}}
.btn-solid{
  background:linear-gradient(135deg,var(--umber-lift) 0%,var(--deep-umber) 48%,var(--umber-edge) 100%);
  color:var(--pale-oat);
  box-shadow:0 2px 14px rgba(42,23,17,.20),inset 0 -2px 0 rgba(208,158,105,.5);
}
.btn-solid:hover{background:linear-gradient(135deg,var(--deep-umber) 0%,var(--warm-clay) 58%,var(--umber-edge) 100%)}
.btn-gold{
  background:linear-gradient(135deg,#E2B98A 0%,var(--golden-sand) 46%,#BE8B55 100%);
  color:var(--deep-umber);
  box-shadow:0 2px 14px rgba(93,53,32,.18),inset 0 -2px 0 rgba(93,53,32,.26);
}
.btn-gold:hover{background:linear-gradient(135deg,var(--golden-sand) 0%,var(--amber-ember) 62%,#A8621F 100%);color:var(--pale-oat)}
.btn-line{
  background:linear-gradient(135deg,var(--sage-veil) 0%,#DDE5D8 52%,var(--sage-veil) 100%);
  color:var(--sage-ink);border:1px solid var(--sage-edge);
  box-shadow:0 2px 12px rgba(70,82,64,.14);
}
.btn-line:hover{background:linear-gradient(135deg,var(--sage-still) 0%,#6C7A68 100%);color:var(--pale-oat);border-color:var(--sage-still)}
.btn-lg{padding:28px 54px;font-size:14.5px}
.full{width:100%}
