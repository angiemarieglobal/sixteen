...
def build_index():
    ...
    html = head(
        ...
        f"{C.SITE}/sixteen",
        og_img=f"{C.SITE}/sixteen/sixteen-hero.jpg",
    )
    ...
    <div class="capgrid">
      ...
      <div class="formcard rv">
        <!-- ==================================================================
             ...
             Redirect after submit:  {C.SITE}/sixteen/{C.THANKS_PATH}
...
{fields}
            ...
            <input type="hidden" name="redirect" value="{C.SITE}/sixteen/{C.THANKS_PATH}">
...
def build_thanks():
    ...
    html = head(
        ...
        f"{C.SITE}/sixteen/{C.THANKS_PATH}",
        noindex=True,
    )
    html += f"""
<div class="tyhead">
