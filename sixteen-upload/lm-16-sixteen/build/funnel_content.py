...
UPSELLS = [
    dict(
        step="One",
        name="Recognise",
        line="Map one loop of your own, backwards.",
        body="Three short audio transmissions and The Loop Map, a printable worksheet that "
             "walks one turn of your own loop. You start at the result, because the result "
             "is the only station you can already see, and you work backwards from there to "
             "the belief nobody ever questioned. Instant access, yours to keep.",
        cta="Go to Recognise",
    ...
    dict(
        step="Two",
        name="Baseline",
        line="Catch it and flip it, for as long as you stay.",
        body="Sixteen names it. Recognise maps it. Baseline is where you practise catching "
             "it in real time and flipping it, over and over. Weekly audio and video drops, "
             "a monthly live transmission, a quiet room, and a library that keeps growing. "
             "You have ninety days. You will spend them looping, or you will spend them "
             "catching it.",
        cta="Go to Baseline",
